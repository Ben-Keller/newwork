...
export const shortLoop = defineType({
  ...
  fields: [
    ...
    defineField({name: 'startMuted', title: 'Start muted', type: 'boolean', group: 'content', initialValue: true, readOnly: true}),
    defineField({name: 'loop', title: 'Loop', type: 'boolean', group: 'content', initialValue: true, readOnly: true}),
    ...captionCreditFields,
